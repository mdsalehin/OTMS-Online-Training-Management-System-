    ...
    <div class="category-area py-120">
        <div class="container">
            ...
            <div class="text-center">
                <a href="#" class="theme-btn mt-5"><span class="fad fa-sync-alt"></span> Explore All Category</a>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat2 cat3 cat7 cat6">
                    <div class="course-item">
                        ...
                        <div class="course-content">
                            ...
                            <a href="#"><h4 class="course-title">The Complete Business Plan Course Includes 50 Templates</h4></a>
                            <div class="course-info">
                                <ul>
                                    <li class="course-lecture"><i class="fad fa-book-open"></i>64 Lectures</li>
                                    <li class="course-duration"><i class="fad fa-clock"></i>30 Hours</li>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat2 cat4 cat5">
                    <div class="course-item">
                        ...
                        <div class="course-content">
                            ...
                            <a href="#"><h4 class="course-title">Become a product Manager learn the skills & job</h4></a>
                            <div class="course-info">
                                <ul>
                                    <li class="course-lecture"><i class="fad fa-book-open"></i>64 Lectures</li>
                                    <li class="course-duration"><i class="fad fa-clock"></i>30 Hours</li>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat4 cat7 cat6">
                    <div class="course-item">
                        ...
                        <div class="course-content">
                            ...
                            <a href="#"><h4 class="course-title">The Complete Digital Marketing Course - 12 Courses in 1</h4></a>
                            <div class="course-info">
                                <ul>
                                    <li class="course-lecture"><i class="fad fa-book-open"></i>64 Lectures</li>
                                    <li class="course-duration"><i class="fad fa-clock"></i>30 Hours</li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="instructor-item">
                        <div class="instructor-img">
                            <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/01.jpg" alt="img"></a>
                        </div>
                        <div class="instructor-content">
                            <span class="instructor-tag">Developer</span>
                            <a href="#" class="d-block"><h5 class="instructor-name">Hector S. Nickel</h5></a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="instructor-item">
                        <div class="instructor-img">
                            <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/02.jpg" alt="img"></a>
                        </div>
                        <div class="instructor-content">
                            <span class="instructor-tag">Designer</span>
                            <a href="#" class="d-block"><h5 class="instructor-name">Mary D. Musser</h5></a>
                            <div class="instructor-rate">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                            ...
                            <span class="instructor-enroll"><i class="far fa-user-friends"></i> 1.5k Students Enrolled</span>
                            <div class="instructor-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="instructor-item">
                        <div class="instructor-img">
                            <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/03.jpg" alt="img"></a>
                        </div>
                        <div class="instructor-content">
                            <span class="instructor-tag">Marketer</span>
                            <a href="#" class="d-block"><h5 class="instructor-name">Jean K. Avendano</h5></a>
                            <div class="instructor-rate">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                            ...
                            <span class="instructor-enroll"><i class="far fa-user-friends"></i> 5.6k Students Enrolled</span>
                            <div class="instructor-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="instructor-item">
                        <div class="instructor-img">
                            <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/04.jpg" alt="img"></a>
                        </div>
                        <div class="instructor-content">
                            <span class="instructor-tag">Adobe</span>
                            <a href="#" class="d-block"><h5 class="instructor-name">Karin M. Chumley</h5></a>
                            <div class="instructor-rate">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                            ...
                            <span class="instructor-enroll"><i class="far fa-user-friends"></i> 2.5k Students Enrolled</span>
                            <div class="instructor-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
