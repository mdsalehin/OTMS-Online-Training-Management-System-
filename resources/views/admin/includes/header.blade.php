                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
													<img src="{{ asset(!empty(auth()->user()->profile_photo_path) ? auth()->user()->profile_photo_path : 'https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExZmt3Yjl2ZHQ4bGFnOTZldHF1bDBjMHV0ZGlobDV2dHQxN3IwN2pzMCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/NG6nBdv9Ba0ONYLBsx/giphy.gif') }}" alt="profile-user"
